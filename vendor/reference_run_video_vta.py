...
if __name__ == '__main__':
    ...
    parser.add_argument("--min-sim", type=float, default=0.3, help="minimum average sim of one segment")
    ...
    parser.add_argument("--tn-top-K", type=int, default=3, help="top k nearest for TN")
    ...
    parser.add_argument("--spd-conf-thres", type=float, default=0.1, help="bounding box conf filter for SPD inference")
