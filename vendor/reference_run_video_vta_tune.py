...
if __name__ == '__main__':
    ...
    parser.add_argument("--min-sim", type=str, default="0.3", help="minimum average sim of one segment")
    ...
    parser.add_argument("--tn-top-K", type=str, default="3", help="top k nearest in tn methods")
